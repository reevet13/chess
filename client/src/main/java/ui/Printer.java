...
public class Printer {
    ...
    void printBoard(ChessGame.TeamColor color, ChessPosition selectedPos) {
        ...
        Collection<ChessMove> possibleMoves = selectedPos != null ?
                game.validMoves(selectedPos) : null;
        HashSet<ChessPosition> possibleSquares = HashSet.newHashSet(possibleMoves !=
                null ? possibleMoves.size() : 0);
