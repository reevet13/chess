...
public class HttpCommunicator {
    ...
    public HttpCommunicator(ServerFacade server, String serverDomain) {
    ...
    public boolean register(String username, String password, String email) {
        ...
        server.setAuthToken((String) res.get("authToken"));
        return true;
    }
    ...
    public boolean login(String username, String password) {
        ...
        server.setAuthToken((String) resp.get("authToken"));
        return true;
    }
    ...
    private HttpURLConnection makeConnection(String method, String endpoint, String body) throws URISyntaxException, IOException {
        ...
        if (server.getAuthToken() != null) {
            http.addRequestProperty("authorization", server.getAuthToken());
        }
